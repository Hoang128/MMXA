...
scr_LOG_INFO("Room number = " + string(room), debugTextColorF, debugTextColorB);
...
if (showDebugHelp)
{
	...
	if (showPlayerLog)
	{
		...
		if instance_exists(obj_playerHumanForm)
		{
			...
			{
				scr_LOG_INFO("Thrust Flag  = " + string(obj_playerZ.cmdThrustFlag), debugTextColorF, debugTextColorB);
