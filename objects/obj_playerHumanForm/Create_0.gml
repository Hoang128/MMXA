...
wallKickTimeMax2 = 6; //Time that player can't go back to wall
wallKickTimeMax = 8; //Wall kick time
hWallKickSpd = 2; //Wall kick speed
dashKickSpd = 3.6; //Dash kick heigh
dashKickTimeMax = 8; //Dash kick time
dashKickFlyTimeMax = 14; //Max dash kick fly time
