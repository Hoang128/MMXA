...
if (setupState)
{
	switch (state)
	{
		...
		case SaberState.SABER_DUCK_SLASH:		{ sprite_index = spr_ZSaberHBSlashDuck;		maxTimmer = 4;	slowTime = false; }	break;
		case SaberState.SABER_SPIN_SLASH:		{ sprite_index = spr_ZSaberHBSlashSpin;		maxTimmer = 3;	slowTime = true;  }	break;
		case SaberState.SABER_SLIDE_SLASH:		{ sprite_index = spr_ZSaberHBSlashSlide;	maxTimmer = 2;	slowTime = false; }	break;
		case SaberState.SABER_CLIMB_SLASH:		{ sprite_index = spr_ZSaberHBSlashClimb;	maxTimmer = 2;	slowTime = false; }	break;
